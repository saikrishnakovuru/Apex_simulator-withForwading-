...
typedef struct APEX_CPU
{
  ...
  int executeForwardBusTagging;
  int isExecuteForwardBusValid;
  int executeForwardBusValue;
  int memoryForwardBusTagging;
  int isMemoryForwardBusValid;
  int memoryForwardBusValue;
...
// void executeForward(APEX_CPU *cpu);
#endif
